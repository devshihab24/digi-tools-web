...
const Supercharge = () => {
  return (
    <div className="flex flex-col-reverse md:flex-row justify-between w-[95%] md:w-[80%] mx-auto items-center gap-10 mb-10 mt-25 lg:mt-30">
      <div className="md:w-[50%] space-y-4 flex flex-col justify-center items-center md:justify-start md:items-start text-center md:text-start">
